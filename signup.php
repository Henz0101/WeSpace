...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (count($errors) === 0) {
        ...
        // Redirect to user personalization page
        ...
        <div class="signup-form">
            ...
            <form action="" method="POST">
                ...
                <div class="footer-text">
                    By creating an account, you agree to the <a href="https://example.com/terms">Terms and Conditions</a> and <a href="https://example.com/privacy">Privacy Policy</a>.
                </div>
                <div class="footer-text">
